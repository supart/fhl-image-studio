...
本仓库是 `FHL Image Studio 方汤圆修改版 V2.0.3` 的公开源码发布树，基于 `RoseKhlifa/Image-Studio` 做独立修改并以 GNU Affero General Public License v3.0 发布。
...
本次 `V2.0.3` 发布源码、Windows Portable 和 Mac DMG 准备流程明确不包含：
